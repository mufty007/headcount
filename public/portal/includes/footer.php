...
$tabBrowse = in_array($currentPage, ['events', 'event-details', 'programs', 'program-details'], true);
...
?>
    ...
    <nav class="portal-bottom-nav" aria-label="Primary">
        <a href="<?= e($navUrls['events']) ?>" class="portal-bottom-nav__item <?= $tabBrowse ? 'is-active' : '' ?>">
