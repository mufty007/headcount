...
<div class="mb-8">
    <h1 class="text-2xl md:text-3xl font-extrabold text-gray-900 tracking-tight">My Family</h1>
    <p class="text-sm md:text-base text-gray-500 mt-1">Manage your family members and their event access.</p>
</div>
...
<div class="max-w-4xl space-y-6">
    ...
    <div class="bento-card">
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-lg font-bold text-gray-900">Add Family Member</h2>
        ...
        <form id="add-family-form" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="space-y-1">
                    <label class="block text-xs font-bold text-gray-600 uppercase tracking-widest">First Name</label>
                    <input type="text" id="family_first_name" name="first_name" required placeholder="Enter first name"
                           class="w-full">
                </div>
                <div class="space-y-1">
                    <label class="block text-xs font-bold text-gray-600 uppercase tracking-widest">Last Name</label>
                    <input type="text" id="family_last_name" name="last_name" required placeholder="Enter last name"
                           class="w-full">
                </div>
                <div class="space-y-1">
                    <label class="block text-xs font-bold text-gray-600 uppercase tracking-widest">Date of Birth</label>
                    <input type="date" id="family_date_of_birth" name="date_of_birth"
                           class="w-full">
                </div>
                <div class="space-y-1">
                    <label class="block text-xs font-bold text-gray-600 uppercase tracking-widest">Relationship</label>
    ...
    <div class="bento-card">
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-lg font-bold text-gray-900">Family Members</h2>
    ...
    <script>
        ...
        function displayFamilyMembers(members) {
            ...
            if (members.length === 0) {
                container.innerHTML = `
                    <div class="text-center py-10 bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200">
                        <div class="p-3 bg-white rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-3 shadow-sm">
                            <svg width="24" height="24" class="w-6 h-6 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                        </div>
            ...
            container.innerHTML = members.map(member => {
                ...
                return `
                    <div class="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-gray-50 rounded-2xl border border-gray-100 hover:border-indigo-200 hover:bg-white transition-all group">
                        <div class="flex items-center mb-4 sm:mb-0">
                            ...
                            <div class="min-w-0">
                                <h3 class="text-base font-bold text-gray-900 truncate">${escapeHtml(member.first_name)} ${escapeHtml(member.last_name)}</h3>
                        ...
                        <button onclick="removeFamilyMember(${member.id})" 
                                class="w-full sm:w-auto px-4 py-2 text-sm font-bold text-red-600 bg-red-50 rounded-xl hover:bg-red-600 hover:text-white transition-all active:scale-95 flex items-center justify-center">
