...
<div class="max-w-8xl mx-auto px-4 py-8" x-data="myProgramsPage()" x-init="init()">
    <div class="mb-8">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <h1 class="text-2xl md:text-3xl font-extrabold text-gray-900 dark:text-white tracking-tight">My programs</h1>
                <p class="text-sm md:text-base text-gray-500 dark:text-gray-400 mt-1">Programs you have joined.</p>
            </div>
        </div>
    </div>
        ...
        <template x-for="row in rows" :key="row.id">
            <div class="bento-card group flex flex-col h-full min-h-0 !p-0 overflow-hidden hover:border-indigo-200 transition-all duration-300">
                ...
                <div class="p-6 flex-1 flex flex-col min-h-0 min-w-0">
                    ...
                    <p class="text-gray-600 dark:text-gray-300 text-sm mb-4 leading-relaxed text-pretty break-words" x-text="descPreview(row)"></p>
                    ...
                    <div class="space-y-3 mb-6">
                        ...
                        <div class="flex items-start gap-3 text-sm font-medium text-gray-700 dark:text-gray-300 min-w-0">
                            ...
                            <span class="px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider bg-violet-100 dark:bg-violet-500/15 text-violet-700 dark:text-violet-300 border border-violet-200 dark:border-violet-500/30 flex-shrink-0" x-show="isVirtual(row)">Virtual</span>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-800 flex-shrink-0 gap-3 mt-auto">
                        <div class="flex flex-col">
                            ...
                            <span class="text-base font-bold text-gray-900 dark:text-white" x-text="priceLabel(row)"></span>
                        </div>
...
function myProgramsPage() {
    ...
    return {
        ...
        registrationBadgeClass(row) {
            ...
            if (s === 'cancelled') {
                return 'bg-rose-50 dark:bg-rose-500/15 text-rose-700 dark:text-rose-300 border-rose-100 dark:border-rose-500/30';
            }
