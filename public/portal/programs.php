...
<div class="max-w-8xl mx-auto px-4 py-8" x-data="programsPage()" x-init="init()">
    <div class="mb-8">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <h1 class="text-2xl md:text-3xl font-extrabold text-gray-900 tracking-tight">Programs</h1>
                <p class="text-sm md:text-base text-gray-500 mt-1">Classes, halaqahs, and ongoing offerings. Member registration only.</p>
            </div>
        </div>
    </div>
            ...
            <template x-for="p in programs" :key="p.id">
                <div class="bento-card group flex flex-col h-full min-h-0 !p-0 overflow-hidden hover:border-indigo-200 transition-all duration-300">
                    ...
                    <div class="p-6 flex-1 flex flex-col min-h-0 min-w-0">
                        ...
                        <p class="text-gray-600 text-sm mb-4 leading-relaxed text-pretty break-words" x-text="descPreview(p)"></p>
                        ...
                        <div class="space-y-3 mb-6">
                            ...
                            <div class="flex items-start gap-3 text-sm font-medium text-gray-700 min-w-0">
                                ...
                                <span class="px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider bg-violet-100 text-violet-700 border border-violet-200 flex-shrink-0" x-show="isVirtual(p)">Virtual</span>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between pt-4 border-t border-gray-100 flex-shrink-0 gap-3 mt-auto">
                            <div class="flex flex-col">
                                ...
                                <span class="text-base font-bold text-gray-900" x-text="priceLabel(p)"></span>
                            </div>
                            <a :href="detailUrl(p)"
