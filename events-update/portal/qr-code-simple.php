...
<div class="max-w-2xl">
        <div class="bento-card p-8 text-center">
            ...
            <div class="flex justify-center mb-6">
                <div id="qr-code-container" class="bg-white dark:bg-gray-800 p-4 rounded-lg border-2 border-gray-200 dark:border-gray-700">
                    <div class="text-gray-500 dark:text-gray-400">Loading QR code...</div>
                </div>
            </div>
